...
type TN_CMCaptDev31Form = class( TN_BaseForm )
    MainPanel:  TPanel;
    RightPanel: TPanel;
    SlidePanel: TPanel;
    bnExit:     TButton;
    ...
    //******************  TN_CMCaptDev31Form class handlers  ******************
  ...
  public
    ...
    ThisForm: TN_CMCaptDev31Form;        // Pointer to this form
...
end; // type TN_CMCaptDev31Form = class( TN_BaseForm )
...
uses
  ...
  N_Lib0, N_Lib2, N_Gra6, N_CompBase, N_Comp1, N_CMMain5F, N_CMCaptDev31,
  N_CMCaptDev31aF, TlHelp32, K_CM1, K_CML1F, N_CMResF, ShellAPI;
{$R *.dfm}
...
// OnShow Self handler
//
procedure TN_CMCaptDev31Form.FormShow( Sender: TObject );
begin
...
end; // procedure TN_CMCaptDev31Form.FormShow

//******************************************** TN_CMCaptDev31Form.FormClose ***
...
//
procedure TN_CMCaptDev31Form.FormClose( Sender: TObject;
...
//  CMOFPProfile.CMDPStrPar1 := CMOFMailslotPath + '/~/' + CMOFPDataPath +
//                                                '/#/' + IntToStr(CMOFNumberPar);
...
//*************************************** TN_CMCaptDev31Form.FormCloseQuery ***
// Perform needed Actions on Closing Self
//
//     Parameters
// Sender - Event Sender
...
// OnClose Self handler
//
procedure TN_CMCaptDev31Form.FormCloseQuery(Sender: TObject;
                                                         var CanClose: Boolean);
begin
  inherited;
end; // TN_CMCaptDev31Form.FormCloseQuery

procedure TN_CMCaptDev31Form.FormCreate(Sender: TObject);
begin
  inherited;

end;

//****************************************** TN_CMCaptDev31Form.FormKeyDown ***
// If key is pressed
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.FormKeyDown( Sender: TObject; var Key: Word;
                                                           Shift: TShiftState );
...
end; // procedure TN_CMCaptDev31Form.FormKeyDown

//******************************************** TN_CMCaptDev31Form.FormKeyUp ***
// If key is unpressed
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.FormKeyUp( Sender: TObject; var Key: Word;
                                                           Shift: TShiftState );
begin
  Exit;
end; // procedure TN_CMCaptDev31Form.FormKeyUp

procedure TN_CMCaptDev31Form.FormPaint(Sender: TObject);
begin
  inherited;
end;

//************************************* TN_CMCaptDev31Form.SlidePanelResize ***
// Redraw Last Captured Slide in CMOFPNewSlides^[0]
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.SlidePanelResize( Sender: TObject );
var
...
end; // procedure TN_CMCaptDev31Form.SlidePanelResize

//**************************************** TN_CMCaptDev31Form.tbLeft90Click ***
...
//
procedure TN_CMCaptDev31Form.tbLeft90Click( Sender: TObject );
begin
...
end; // procedure TN_CMCaptDev31Form.tbLeft90Click

//*************************************** TN_CMCaptDev31Form.tbRight90Click ***
...
//
procedure TN_CMCaptDev31Form.tbRight90Click( Sender: TObject );
begin
  if CMOFNumCaptured <= 0 then Exit;
  ...
  // Show NewSlide in SlideRFrame
  SlideRFrame.RFrShowComp( CMOFPNewSlides^[0].GetMapRoot() );
end; // TN_CMCaptDev31Form.tbRight90Click

// procedure TN_CMCaptDev31Form.UpDown1Click
procedure TN_CMCaptDev31Form.UpDown1Click( Sender: TObject; Button: TUDBtnType );
begin
end; // procedure TN_CMCaptDev31Form.UpDown1Click

//******************************************* TN_CMCaptDev31Form.tb180Click ***
...
//
procedure TN_CMCaptDev31Form.tb180Click( Sender: TObject );
begin
  if CMOFNumCaptured <= 0 then Exit;
  ...
  // Show NewSlide in SlideRFrame
  SlideRFrame.RFrShowComp( CMOFPNewSlides^[0].GetMapRoot() );
end; // procedure TN_CMCaptDev31Form.tb180Click

//*************************************** TN_CMCaptDev31Form.tbFlipHorClick ***
...
//
procedure TN_CMCaptDev31Form.tbFlipHorClick( Sender: TObject );
begin
  if CMOFNumCaptured <= 0 then Exit;
  ...
  // Show NewSlide in SlideRFrame
  SlideRFrame.RFrShowComp( CMOFPNewSlides^[0].GetMapRoot() );
end; // procedure TN_CMCaptDev31Form.tbFlipHorClick


//**********************  TN_CMCaptDev31Form class public methods  ************

//**************************************** TN_CMCaptDev31Form.CMOFDrawThumb ***
...
//
procedure TN_CMCaptDev31Form.CMOFDrawThumb( ADGObj: TN_DGridBase; AInd: Integer;
                                                          const ARect: TRect );
begin
...
end; // end of TN_CMCaptDev31Form.CMOFDrawThumb

//************************************* TN_CMCaptDev31Form.CMOFGetThumbSize ***
...
//
procedure TN_CMCaptDev31Form.CMOFGetThumbSize( ADGObj: TN_DGridBase;
...
end; // procedure TN_CMCaptDev31Form.CMOFGetThumbSize

//****************************************** TN_CMCaptDev31Form.bnOpenClick ***
// Open Sidexis
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.bnOpenClick( Sender: TObject );
begin
  inherited;
...
end; // procedure TN_CMCaptDev31Form.bnOpenClick

//***************************************** TN_CMCaptDev31Form.bnSetupClick ***
// Setup
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.bnSetupClick(Sender: TObject);
var
...
begin
  ...
  Form.CMOFPDevProfile := N_CMCDServObj31.PProfile;
...
end; // procedure TN_CMCaptDev31Form.bnSetupClick

//****************************************** TN_CMCaptDev31Form.bnStopClick ***
// Stop waiting for Sidexis
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.bnStopClick( Sender: TObject );
begin
  inherited;
  ...
  //CMOfOpened            := False;
end; // procedure TN_CMCaptDev31Form.bnStopClick

//*************************************** TN_CMCaptDev31Form.bnCaptureClick ***
// Capture start
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.bnCaptureClick(Sender: TObject);
var
...
begin
  ...
  N_CMCDServObj31.StartDriver( ThisForm.Handle );
...
//************************************* TN_CMCaptDev31Form.CMOFCaptureSlide ***
...
// Return 0 if OK
//
function TN_CMCaptDev31Form.CMOFCaptureSlide( Image: string ): Integer;
var
  i: Integer;
...
begin
  ...
  Result := 0;
end; // end of TN_CMCaptDev31Form.CMOFCaptureSlide

//************************************* TN_CMCaptDev31Form.CurStateToMemIni ***
// Save Current Self State (ComboBox Items and others)
//
procedure TN_CMCaptDev31Form.CurStateToMemIni();
begin
  Inherited;
end; // end of procedure TN_CMCaptDev31Form.CurStateToMemIni

//************************************* TN_CMCaptDev31Form.MemIniToCurState ***
// Load Current Self State (ComboBox Items and others)
//
procedure TN_CMCaptDev31Form.MemIniToCurState();
begin
  Inherited;
end; procedure TN_CMCaptDev31Form.RadioGroup1Click(Sender: TObject);
begin
  inherited;

end;

// end of procedure TN_CMCaptDev31Form.MemIniToCurState

//********************************** TN_CMCaptDev31Form.Timer3DEnabledTimer ***
// Checks if 3d import is available
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.Timer3DEnabledTimer( Sender: TObject );
begin
  inherited;
  // not implemented for 2d
end; // procedure TN_CMCaptDev31Form.Timer3DEnabledTimer

//************************************** TN_CMCaptDev31Form.TimerImageTimer ***
// Wait for 3d info file
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.TimerImageTimer( Sender: TObject );
var
  ImportFile: string;
  Txt:      TextFile;
...
begin
  ...
  begin
    ...
    N_Dump1Str( 'Newest file = ' + ImportFile );
    if CMOFTempNewestPath <> ImportFile then // images formats
    if ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.bmp' ) or
       ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.jpg' ) or
      ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.jpeg' ) or
       ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.tif' ) or
      ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.tiff' ) or
      ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.jp2' ) or
      ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.j2k' ) or
      ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.j2c' ) or
       ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.png' ) then
    begin
      CMOFCaptureSlide( CMOFPDataPath+ImportFile );
      CMOFTempNewestPath := ImportFile;
      DeleteFile( CMOFPDataPath+ImportFile );
    end
    else
    if ImportFile = 'sidexis.sdx' then // if the newest is info-file
    begin
      DeleteFile( CMOFPDataPath+ImportFile );
      CMOFTempNewestPath := ImportFile;

      ImportFile := FindNewestFile( CMOFPDataPath ); // start check again
      N_Dump1Str( 'Newest file = ' + ImportFile );
      if CMOFTempNewestPath <> ImportFile then // images formats
      if ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.bmp' ) or
         ( ExtractFileExt( CMOFPDataPath+ImportFile ) = '.jpg' ) or
...
end; // procedure TN_CMCaptDev31Form.TimerImageTimer

//************************************ TN_CMCaptDev31Form.TimerSidexisTimer ***
// Wait for Sidexis while it opens
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.TimerSidexisTimer( Sender: TObject );
begin
// not implemented
end;// procedure TN_CMCaptDev31Form.TimerSidexisTimer

//************************************* TN_CMCaptDev31Form.TimerStatusTimer ***
// Changing status
//
//     Parameters
// Sender - Event Sender
//
procedure TN_CMCaptDev31Form.TimerStatusTimer( Sender: TObject );
begin
  inherited;
...
end;// procedure TN_CMCaptDev31Form.TimerStatusTimer
