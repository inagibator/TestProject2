...
uses
  ...
  A_DBAnonymizer in 'A_DBAnonymizer.pas',
  N_CMCaptDev35 in 'N_CMCaptDev35.pas',
  N_CMCaptDev35F in 'N_CMCaptDev35F.pas' {N_CMCaptDev35Form},
  A_DBAnonymizerSettings in 'A_DBAnonymizerSettings.pas' {DBAnonymizerSettings},
...
//
  ...
  Application.CreateForm(TDICOMViewer, DICOMViewer);
  Application.CreateForm(TSeriesGraphicViewer, SeriesGraphicViewer);
  Application.CreateForm(TProgress, Progress);
  Application.CreateForm(TK_FormCMExportSlidesAll, K_FormCMExportSlidesAll);
  Application.Run;
    Exit;
...
//        Application.Icon.LoadFromFile( FName );
  ...
  begin
      N_Dump1Str( '***** Application mode Support' );
      Application.CreateForm( TK_FormCMSupport, K_FormCMSupport );
      Application.OnException := K_FormCMSupport.OnUHException;
      OnExcept := K_FormCMSupport.OnUHException;
      // Prepare LLL Forms code should be inserted
      // ...
      Application.CreateForm(TN_CMResForm, N_CMResForm);
      K_CMDICOMNewFlag := FALSE;
