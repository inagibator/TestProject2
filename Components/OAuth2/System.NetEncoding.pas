  ...
  begin
    case State.Step of
      ...
      begin
        ...
        Inc(POut, CharSize);
        C := (B and $3) shl 4;
        State.Step := TEncodeStep.EncodeStepB;
      end;
      ...
      begin
        ...
        Inc(POut, CharSize);
        C := (B and $F) shl 2;
        State.Step := TEncodeStep.EncodeStepC;
      end;
      ...
      begin
        ...
        State.Step := TEncodeStep.EncodeStepA;
      end;
    end;
  end;
  State.Result := C;
