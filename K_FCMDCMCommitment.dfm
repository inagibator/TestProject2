inherited K_FormCMDCMCommitment: TK_FormCMDCMCommitment
  Left = 313
  Top = 152
  Width = 722
  Height = 322
  ...
  object ChBRedoComm: TCheckBox
    Left = 13
    Top = 257
    Width = 124
    Height = 17
    Anchors = [akLeft, akBottom]
    Caption = 'Redo Commitment'
    TabOrder = 5
    OnClick = ChBRedoCommClick
  end
end
