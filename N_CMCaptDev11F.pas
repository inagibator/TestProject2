unit N_CMCaptDev11F;
// Form for capture Images from Trident Devices
// 2014.01.04 Added USB plug / unplug reaction by Valery Ovechkin
// 2014.01.04 Changed filter applying condition by Valery Ovechkin
// 2014.01.04 Added nil check for XE5 by Valery Ovechkin, line 228
// 2014.02.21 Fixed log strings from 'E2V' to 'Trident'
...
type TN_CMCaptDev11Form = class( TN_BaseForm )
    MainPanel: TPanel;
    RightPanel: TPanel;
    SlidePanel: TPanel;
    bnExit: TButton;
    ...
    //****************  TN_CMCaptDev11Form class handlers  ******************
...
end; // type TN_CMCaptDev11Form = class( TN_BaseForm )
...
uses
  ...
  N_Lib0, N_Lib2, N_Gra6, N_CompBase, N_Comp1, N_CMMain5F, N_CMCaptDev11, N_CMCaptDev0;
{$R *.dfm}

//****************  TN_CMCaptDev11Form class handlers  ******************

//*************************************** TN_CMCaptDev11Form.WMDeviceChange ***
// USB event
//
//     Parameters
// AMsg - Windows message
//
procedure TN_CMCaptDev11Form.WMDeviceChange( var AMsg: TMessage );
begin
  N_CMCDServObj11.USBProc( AMsg );
end; // procedure TN_CMCaptDev11Form.WMDeviceChange

//********************************************** TN_CMCaptDev11Form.FormShow ***
...
// OnShow Self handler
//
procedure TN_CMCaptDev11Form.FormShow( Sender: TObject );
begin
  N_Dump1Str( 'Trident Start FormShow' );
  ...
  // This Code is moved here from FormActivate (because sometimes FormActivate was escape)
  N_CMV_USBReg( Self.Handle, N_CMCDServObj11.USBHandle );

  N_Dump1Str( 'Trident End FormShow' );
end; // procedure TN_CMCaptDev11Form.FormShow

//********************************************* TN_CMCaptDev11Form.FormClose ***
...
//
procedure TN_CMCaptDev11Form.FormClose( Sender: TObject; var Action: TCloseAction );
begin
  N_Dump2Str( 'TN_CMCaptDev11Form.FormClose Start' );
  TimerCheck.Enabled := False;
  N_CMV_USBUnreg( N_CMCDServObj11.USBHandle );
  N_CMCDServObj11.TridentDisArm();
  //N_CMCDServObj11.AcqThreadFree();
  //N_CMCDServObj11.CDSFreeAll();
  CMOFDrawSlideObj.Free;
  CMOFThumbsDGrid.Free;
  SetLength( N_CMCDServObj11.ImageBufCapt,  0 );
  Inherited;
  N_Dump2Str( 'TN_CMCaptDev11Form.FormClose Fin' );
end; // TN_CMCaptDev11Form.FormClose

// procedure TN_CMCaptDev11Form.FormKeyDown
procedure TN_CMCaptDev11Form.FormKeyDown( Sender: TObject; var Key: Word; Shift: TShiftState );
...
end; // procedure TN_CMCaptDev11Form.FormKeyDown

// procedure TN_CMCaptDev11Form.FormKeyUp
procedure TN_CMCaptDev11Form.FormKeyUp( Sender: TObject; var Key: Word; Shift: TShiftState );
begin
  Exit;
end; // procedure TN_CMCaptDev11Form.FormKeyUp

// procedure TN_CMCaptDev11Form.cbAutoTakeClick
procedure TN_CMCaptDev11Form.cbAutoTakeClick( Sender: TObject );
begin
  inherited;

  if cbAutoTake.Checked then
  begin
    N_CMCDServObj11.TridentArm();
  end
  else
  begin
    N_CMCDServObj11.TridentDisArm();
  ...
  N_CMCDServObj11.ShowDeviceStatus( Self );
end; // procedure TN_CMCaptDev11Form.cbAutoTakeClick

// procedure TN_CMCaptDev11Form.SlidePanelResize
procedure TN_CMCaptDev11Form.SlidePanelResize( Sender: TObject );
...
end; // procedure TN_CMCaptDev11Form.SlidePanelResize

//**************************************** TN_CMCaptDev11Form.bnCaptureClick ***
...
//
procedure TN_CMCaptDev11Form.bnCaptureClick( Sender: TObject );
begin
  ...
  N_CMCDServObj11.TridentArm();
  TimerCheck.Enabled := True;
end; // procedure TN_CMCaptDev11Form.bnCaptureClick

//***************************************** TN_CMCaptDev11Form.tbLeft90Click ***
...
//
procedure TN_CMCaptDev11Form.tbLeft90Click( Sender: TObject );
begin
...
end; // procedure TN_CMCaptDev11Form.tbLeft90Click

//**************************************** TN_CMCaptDev11Form.tbRight90Click ***
...
//
procedure TN_CMCaptDev11Form.tbRight90Click( Sender: TObject );
begin
  if CMOFNumCaptured <= 0 then Exit;
  ...
  // Show NewSlide in SlideRFrame
  SlideRFrame.RFrShowComp( CMOFPNewSlides^[0].GetMapRoot() );
end; // TN_CMCaptDev11Form.tbRight90Click

// procedure TN_CMCaptDev11Form.timer_checkTimer
procedure TN_CMCaptDev11Form.TimerCheckTimer( Sender: TObject );
begin
  N_CMCDServObj11.TridentOnTimer( Self, nil );
end; // procedure TN_CMCaptDev11Form.timer_checkTimer

// procedure TN_CMCaptDev11Form.UpDown1Click
procedure TN_CMCaptDev11Form.UpDown1Click( Sender: TObject; Button: TUDBtnType );
begin
end; // procedure TN_CMCaptDev11Form.UpDown1Click

// procedure TN_CMCaptDev11Form.tbRight90Click

//******************************************** TN_CMCaptDev11Form.tb180Click ***
...
//
procedure TN_CMCaptDev11Form.tb180Click( Sender: TObject );
begin
  if CMOFNumCaptured <= 0 then Exit;
  ...
  // Show NewSlide in SlideRFrame
  SlideRFrame.RFrShowComp( CMOFPNewSlides^[0].GetMapRoot() );
end; // procedure TN_CMCaptDev11Form.tb180Click

//**************************************** TN_CMCaptDev11Form.tbFlipHorClick ***
...
//
procedure TN_CMCaptDev11Form.tbFlipHorClick( Sender: TObject );
begin
  if CMOFNumCaptured <= 0 then Exit;
  ...
  // Show NewSlide in SlideRFrame
  SlideRFrame.RFrShowComp( CMOFPNewSlides^[0].GetMapRoot() );
end; // procedure TN_CMCaptDev11Form.tbFlipHorClick


//****************  TN_CMCaptDev11Form class public methods  ************

//***************************************** TN_CMCaptDev11Form.CMOFDrawThumb ***
...
//
procedure TN_CMCaptDev11Form.CMOFDrawThumb( ADGObj: TN_DGridBase; AInd: Integer;
                                                          const ARect: TRect );
begin
...
end; // end of TN_CMCaptDev11Form.CMOFDrawThumb

//************************************** TN_CMCaptDev11Form.CMOFGetThumbSize ***
...
//
procedure TN_CMCaptDev11Form.CMOFGetThumbSize( ADGObj: TN_DGridBase; AInd: Integer;
...
end; // procedure TN_CMCaptDev11Form.CMOFGetThumbSize

//***************************************** TN_CMCaptDev11Form.CMOFSetStatus ***
// procedure TN_CMCaptDev11Form.bnExitClick
procedure TN_CMCaptDev11Form.bnExitClick( Sender: TObject );
begin
  inherited;
end; // procedure TN_CMCaptDev11Form.bnExitClick

// procedure TN_CMCaptDev11Form.bnSetupClick
procedure TN_CMCaptDev11Form.bnSetupClick( Sender: TObject );
begin
  inherited;
  TimerCheck.Enabled := False; // disable timer
  N_CMCDServObj11.TridentDisArm(); // disarm the sensor

  // show device settings
  N_CMCDServObj11.CDSSettingsDlg( N_CMCDServObj11.PProfile );
  // if device was armed before setup click

  TimerCheck.Enabled := True; // enable timer
end; // procedure TN_CMCaptDev11Form.bnSetupClick

//************************************** TN_CMCaptDev11Form.CMOFCaptureSlide ***
// Capture Slide from file and show it
//
//     Parameters
// Result - 0 if OK
//
function TN_CMCaptDev11Form.CMOFCaptureSlide(): Integer;
var
  i: Integer;
  CapturedDIB: TN_DIBObj;
  NewSlide: TN_UDCMSlide;
  RootComp: TN_UDCompVis;
  ProfileParamsStr: String;
  ApplyFilter: Boolean;
begin
  Result := 0;
  Inc( CMOFNumCaptured ); // now CMOFNumCaptured can be used as Slide number
  CapturedDIB := TN_DIBObj.Create(); // create DIB
  CapturedDIB.PrepEmptyDIBObj( N_CMCDServObj11.ImageWidth, N_CMCDServObj11.ImageHeight,
  ...
  for i := 0 to N_CMCDServObj11.ImageHeight - 1 do // along all pixel rows
    move( N_CMCDServObj11.ImageBufCapt[i * N_CMCDServObj11.ImageWidth],
  ...
  ProfileParamsStr := CMOFPProfile.CMDPStrPar1;

  // apply filter
  ApplyFilter := True;

  if ( Length( ProfileParamsStr ) > 7 ) then
    if ( Copy( ProfileParamsStr, 8, 1 ) <> '1' ) then
      ApplyFilter := False;
  ...
  SlideRFrame.RFrShowComp( RootComp );
end; // end of TN_CMCaptDev11Form.CMOFCaptureSlide

//************************************** TN_CMCaptDev11Form.CurStateToMemIni ***
// Save Current Self State (ComboBox Items and others)
//
procedure TN_CMCaptDev11Form.CurStateToMemIni();
begin
  Inherited;
end; // end of procedure TN_CMCaptDev11Form.CurStateToMemIni

//************************************** TN_CMCaptDev11Form.MemIniToCurState ***
// Load Current Self State (ComboBox Items and others)
//
procedure TN_CMCaptDev11Form.MemIniToCurState();
begin
  Inherited;
end; // end of procedure TN_CMCaptDev11Form.MemIniToCurState
