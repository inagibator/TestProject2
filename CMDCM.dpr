...
//        Application.Icon.LoadFromFile( FName );
  ...
  begin
      N_Dump1Str( '***** Application mode DCMExe' );
      Application.CreateForm( TK_FormCMDCMExe, K_FormCMDCMExe );
      Application.ShowMainForm := FALSE;
      Application.OnException := K_FormCMDCMExe.OnUHException;
      OnExcept := K_FormCMDCMExe.OnUHException;
      K_CMSAppStartContext.CMASMode := K_cmamDCMExe;
      K_FormCMDCMExe.FormShow(Application);
