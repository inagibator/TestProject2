...
type
  TK_FormCMSSharpAttrsN = class(TN_BaseForm)
    BtCancel: TButton;
    BtOK    : TButton;
    TBVal: TTrackBar;
    BtApply: TButton;
...
var
  K_FormCMSSharpAttrsN: TK_FormCMSSharpAttrsN;

function K_CMSSharpenNDlg( ) : Boolean;
...
begin
  with N_CM_MainForm, CMMFActiveEdFrame,
      TK_FormCMSSharpAttrsN.Create(Application) do begin
//    BaseFormInit( nil );
...
procedure TK_FormCMSSharpAttrsN.TBValChange(Sender: TObject);
begin
...
procedure TK_FormCMSSharpAttrsN.BtApplyClick(Sender: TObject);
var
  VKR : Char;
begin
...
procedure TK_FormCMSSharpAttrsN.TimerTimer(Sender: TObject);
var
  Base : Integer;
  ConvFactor : Double;
  VConvFactor : Double;
...
//      SharpDepth := 9;
      SharpDepth := 7;
//      SharpDepth := 5;
//      K_CalcGaussMatr( SharpCoefs, SharpDepth, 10.0 );
...
procedure TK_FormCMSSharpAttrsN.LbEdConvFactorKeyPress(Sender: TObject;
  var Key: Char);
var
  VConvFactor : Double;
  NPos : Integer;
...
procedure TK_FormCMSSharpAttrsN.BtOKClick(Sender: TObject);
var
  VKR : Char;
begin
...
procedure TK_FormCMSSharpAttrsN.FormCloseQuery(Sender: TObject;
