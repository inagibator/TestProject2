...
type TN_CMCaptDev31aForm = class( TN_BaseForm )
  bnOK:             TButton;
...
//******************************************* TN_CMCaptDev31aForm.bnOKClick ***
// Button "OK" click event handler
//
//     Parameters
// Sender - sender object
//
procedure TN_CMCaptDev31aForm.ApplyClick(Sender: TObject);
begin
  inherited;
...
procedure TN_CMCaptDev31aForm.bnOKClick( Sender: TObject );
begin
  // creating a final string
  CMOFPDevProfile.CMDPStrPar1 := SrcMailslotFrame.mbPathName.Text +
                                                   edMailslotName.Text + '/~/' +
                         SrcImagesFrame.mbPathName.Text + '/#/' + edNumber.Text;
end; // procedure TN_CMCaptDev31aForm.bnOKClick

//******************************************** TN_CMCaptDev31aForm.FormShow ***
// FormShow event handler
//
//     Parameters
// Sender - sender object
//
procedure TN_CMCaptDev31aForm.FormShow( Sender: TObject );
begin
  inherited;
...
end; // procedure TN_CMCaptDev31aForm.FormShow( Sender: TObject );

//************************************ TN_CMCaptDev31aForm.RadioGroup1Click ***
// Chosed a device mode event
//
//     Parameters
// Sender - sender object
//
procedure TN_CMCaptDev31aForm.RadioGroup1Click( Sender: TObject );
begin
  inherited;
  // save chosed mode (actual mode will be more by 1 then a chosed index)
end; // procedure TN_CMCaptDev31aForm.RadioGroup1Click
