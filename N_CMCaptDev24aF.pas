...
type TN_CMCaptDev24aForm = class( TN_BaseForm )
  bnOK:        TButton;
...
//
procedure TN_CMCaptDev24aForm.bnOKClick( Sender: TObject );
begin
...
// Sender - sender object
//
procedure TN_CMCaptDev24aForm.FormShow( Sender: TObject );
begin
  inherited;
...
// Sender - sender object
//
procedure TN_CMCaptDev24aForm.RadioGroup1Click( Sender: TObject );
begin
  inherited;
